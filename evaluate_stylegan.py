...
generator = load_model('E:/stylegan_model/sg_gan_generator.h5')
...
original_accuracy = evaluate_on_original_dataset(images, labels)
combined_accuracy = evaluate_on_combined_dataset(generator, images, labels, num_samples=NUM_SAMPLES)
